...
void sharedMain(OLWrapperFactory factory, {bool skipChangeRecords: false}) {
  ...
  void doChanges() {
    list.deliverChanges();
    (rol as Observable).deliverChanges();
  }
  ...
  group('observe length', () {
    ...
    setUp(() {
      ...
      rol = factory(list);
      changes = null;
      sub = (rol as Observable).changes.listen((records) {
  ...
  if(!skipChangeRecords) {
    ...
    group('change records', () {
      ...
      setUp(() {
        ...
        rol = factory(list);
        changes = null;
        sub = (rol as Observable).changes.listen((r) { changes = r; });
      });
